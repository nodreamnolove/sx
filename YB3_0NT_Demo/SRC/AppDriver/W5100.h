...
#define	W5100_LINK      ( P3_INP_STATE & ( 1 << 6 ) )   		// GPI06连接检测脚，低电平表示连接正常
...
W5100_EXT	uint8	S_tx_process(SOCKET s, uint8 *buf,uint32 size);
W5100_EXT	void	W5100_Interrupt_Process(void);

/* 端口数据缓冲区 */
#define	W5100BUFSIZE	5000					  ///
#ifndef SIM_SOFTWARE
#define    Max_Size     831				  ///
#else 
#define    Max_Size     1461
#endif
W5100_EXT	uint16 RecevieData_Size_00;			  ///
W5100_EXT	uint16 RecevieData_Size_01;			  ///
W5100_EXT	uint16 RecevieData_Size_02;


W5100_EXT	uint8	Rx_Buffer[W5100BUFSIZE];				/* 端口接收数据缓冲区 */
//W5100_EXT	uint8	Rx_Buffer[200000];				/* 端口接收数据缓冲区 */
...
//W5100_EXT	unsigned int Ser_Ip[4] = {192,168,1,50};	//服务器IP地址 
