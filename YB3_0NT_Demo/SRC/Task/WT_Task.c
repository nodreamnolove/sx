...
//	EndAngle	=	161;
	...
	SETUPALIAS.HeightLaser0 = 7100;                           //激光器垂直高度值
	SETUPALIAS.HeightLaser1 = 7300;                           //激光器垂直高度值
	SETUPALIAS.HeightLaser2 = 6100;                           //激光器垂直高度值
	SETUPALIAS.HeightLaser3 = 6100;                           //激光器垂直高度值	  	  
//	SETUPALIAS.IncHeightLaser = 0;
	SETUPALIAS.LaserDistance = 7530;	                        //激光器之间距离
//	SETUPALIAS.Angle12 = 45;						    	//倾斜激光器的角度
	SETUPALIAS.LaneWide = 470;                              //%车道宽度
	SETUPALIAS.MedianWide = 200;                       //隔离带右边宽度
	SETUPALIAS.MedianLeftWide = 200;         	            //隔离带左边宽度
	SETUPALIAS.u8DOG  = 1;
	SETUPALIAS.u32LaserRoadAngle  = 45;                 //激光扫描截面偏角
	...
	SETUPALIAS.u16VerticalZeroPos0 = 188;   //默认垂直激光器0点位置		  20130426
	SETUPALIAS.u16VerticalZeroPos1 = 181;   //默认垂直激光器0点位置		  20130426
	SETUPALIAS.u16VerticalZeroPos2 = 178;   //默认垂直激光器0点位置		  20130426
	SETUPALIAS.u16VerticalZeroPos3 = 178;   //默认垂直激光器0点位置		  20130426
//	SETUPALIAS.u16InclineZeroPos  = 180;   //默认倾斜激光器0点位置
	SETUPALIAS.u16StartPtNum0      = 60;    //默认起始点数
	SETUPALIAS.u16EndPtNum0        = SETUPALIAS.u16VerticalZeroPos0;   //默认终止点数
	SETUPALIAS.u16StartPtNum1      = SETUPALIAS.u16VerticalZeroPos1;    //默认起始点数
	SETUPALIAS.u16EndPtNum1        = 300;   //默认终止点数
	SETUPALIAS.u16StartPtNum2      = 30;    //默认起始点数
	SETUPALIAS.u16EndPtNum2        = 300;   //默认终止点数
	SETUPALIAS.u16StartPtNum3      = 30;    //默认起始点数
	SETUPALIAS.u16EndPtNum3        = 300;   //默认终止点数
...
//	g_SD_single_Veh = OSSemCreate(0); //产生新车时发送信号量，SD任务请求信号量，用于存储该新车信息。
	...
	NET_flag = OSSemCreate(1);	//网络的资源标志
...
//读铁电特定位置的值   仅调试用
//	Read256_full(BUF1ADDR,testtemp,4);		//出队操作
